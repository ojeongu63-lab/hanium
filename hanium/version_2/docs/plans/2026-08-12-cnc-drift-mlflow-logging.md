...
**Files:**
- Create: `version_2/src/monitoring/mlflow_logging.py`
- Create: `version_2/tests/monitoring/test_mlflow_logging.py`
...
`version_2/tests/monitoring/test_mlflow_logging.py`:
```python
...
Run: `cd version_2 && uv run pytest tests/monitoring/test_mlflow_logging.py -v`
Expected: FAIL(`ModuleNotFoundError`)

- [ ] **Step 3: `mlflow_logging.py` 구현**

`version_2/src/monitoring/mlflow_logging.py`:
```python
...
```bash
git add version_2/src/monitoring/mlflow_logging.py version_2/tests/monitoring/test_mlflow_logging.py
...
Run: `cd version_2 && uv run python -m py_compile src/serving/app.py`
Expected: 에러 없이 종료
...
```bash
git add version_2/src/serving/app.py
