...
- Create: `version_2/src/monitoring/__init__.py`, `logging.py`, `drift.py`
- Create: `version_2/tests/monitoring/test_logging.py`, `test_drift.py`
- Modify: `version_2/src/serving/app.py`
- Modify: `version_2/tests/serving/test_app.py`
- Create: `version_2/monitoring/simulate_drift.py`
- Create: `version_2/monitoring/.gitignore`(비어있음 방지용 — 실제로는 `data/monitoring/`이 산출물 위치라 이 폴더 자체엔 불필요, 아래 참고)

## Task 1: `src/monitoring/logging.py` — 요청 로그 누적

**Files:**
- Create: `version_2/src/monitoring/__init__.py`(빈 파일)
- Create: `version_2/src/monitoring/logging.py`
- Create: `version_2/tests/monitoring/test_logging.py`
...
**주의**: `version_2/tests/monitoring/`에는 `__init__.py`를 만들지 않는다 — 이전
...
`version_2/src/monitoring/__init__.py`: 빈 파일.

- [ ] **Step 2: 실패하는 테스트 작성**

`version_2/tests/monitoring/test_logging.py`:
```python
...
Run: `cd version_2 && uv run pytest tests/monitoring/test_logging.py -v`
Expected: FAIL(`ModuleNotFoundError: No module named 'monitoring.logging'`)

- [ ] **Step 4: `logging.py` 구현**

`version_2/src/monitoring/logging.py`:
```python
import json
import sqlite3
...
```bash
git add version_2/src/monitoring/__init__.py version_2/src/monitoring/logging.py \
        version_2/tests/monitoring/test_logging.py
...
**Files:**
- Create: `version_2/src/monitoring/drift.py`
- Create: `version_2/tests/monitoring/test_drift.py`
...
`version_2/tests/monitoring/test_drift.py`:
```python
...
Run: `cd version_2 && uv run pytest tests/monitoring/test_drift.py -v`
Expected: FAIL(`ModuleNotFoundError`)

- [ ] **Step 3: `drift.py` 구현**

`version_2/src/monitoring/drift.py`:
```python
...
```bash
git add version_2/src/monitoring/drift.py version_2/tests/monitoring/test_drift.py
...
Run: `cd version_2 && uv run pytest tests/serving/test_app.py -v -k drift`
...
```bash
git add version_2/src/serving/app.py version_2/tests/serving/test_app.py
...
Run: `cd version_2 && uv run python -m py_compile monitoring/simulate_drift.py`
Expected: 에러 없이 종료
...
```bash
git add version_2/monitoring/simulate_drift.py
