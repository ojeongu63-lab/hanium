...
## Part A — 증강 데이터 생성 (`02-cnc-machining/augmentation/generate_augmented.py`)
...
## Part B — 증강 반영 LOOCV (`02-cnc-machining/loocv/run_loocv_augmented.py`)
...
| 파일 | 변경 |
|---|---|
| `02-cnc-machining/augmentation/generate_augmented.py` | 신규 |
| `02-cnc-machining/loocv/run_loocv_augmented.py` | 신규 |
